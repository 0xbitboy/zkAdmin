package club.calabashbrothers.zkadmin.utils;

/**
 * Created by liaojiacan on 2016/7/1.
 */
/*
...
public abstract class RegexpUtils {
    ...
    public static final Pattern MOBILEPHONE_NUMBER=Pattern.compile("(^(13\\d|15[^4,\\D]|17[13678]|18\\d)\\d{8}|170[^346,\\D]\\d{7})$");
    ...
    public static boolean isTelephone(String phone){
        return matches(phone,TELEPHONE_NUMBER.pattern());
    }
    /**
     * 判断是否是电话号码
     * @param phone
    ...
    public static boolean isMobilephone(String phone){
        return matches(phone,MOBILEPHONE_NUMBER.pattern());
    }

    public static void main(String[] args) {
        System.out.println(isMobilephone("15915839896"));
    }
}
